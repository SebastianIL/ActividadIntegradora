...
class Ciudad(mesa.Model):
    def __init__(self, num_agents, width, height):
        ...
        semaforo1 = Semaforo(13, self)
        semaforo2 = Semaforo(14, self)
        ...
        self.grid.place_agent(semaforo1, (28, 31))
        self.grid.place_agent(semaforo1, (28, 30))
        # !!!!!!!!!!!!!!!! Opuestos !!!!!!!!!!!!!!!!
        self.grid.place_agent(semaforo2, (30, 29))
        self.grid.place_agent(semaforo2, (29, 29))
